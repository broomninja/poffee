defmodule PoffeeWeb.CoreComponents do
  @moduledoc """
  ...
  def responsive_indicator(assigns) do
    ~H"""
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PoffeeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PoffeeWeb.Gettext, "errors", msg, opts)
    end
  end
